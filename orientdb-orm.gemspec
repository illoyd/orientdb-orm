...
Gem::Specification.new do |spec|
  spec.name          = "orientdb-orm"
  spec.version       = Orientdb::ORM::VERSION
  spec.authors       = ["Ian Lloyd"]
  spec.email         = ["ian.w.lloyd@gmail.com"]

  spec.summary       = %q{ Simple ORM for OrientDB }
  spec.description   = %q{ Simple ORM for OrientDB }
  spec.homepage      = "http://signalcloudapp.com"
  spec.license       = "MIT"
