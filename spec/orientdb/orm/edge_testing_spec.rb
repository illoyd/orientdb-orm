...
describe 'Edge Detection', :with_database do
  ...
  fit 'adds edge OUT attributes to vertices' do
    ...
    expect( v1a._field_types.field_types['in_ExampleEdge'] ).to eq(Orientdb::ORM::LinkBagType)
    ...
    expect( v2a._field_types.field_types['out_ExampleEdge'] ).to eq(Orientdb::ORM::LinkBagType)
